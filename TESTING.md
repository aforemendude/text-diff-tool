...
| `accessibility.spec.ts` | `gives settings controls concise names, descriptions, and keyboard focus indicators`       | Uses the browser accessibility tree and computed focus styles for the settings form.                            |
...
| `src/App.test.tsx`                        | State ownership and child wiring; success, identity, parse-error, processing-error, cancellation, unmount, modal, and Edit transitions.                                                                                                                                      |
